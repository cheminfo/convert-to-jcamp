...
test('create and read spectrum differents xyEncoding factor != 1', () => {
  const spectrum = {
    x: xAxis,
    y: yPositive,
  };
...
test('create and read spectrum differents xyEncoding', () => {
  const spectrum = {
    x: xAxis,
    y: yPositive,
  };
...
test('simple example to check xyEncoding', () => {
  const spectrum = {
    x: [0, 1, 2, 3, 4],
    y: [0, 1, 2, 3, 4],
  };
...
test('create and read spectrum y in zeros differents xyEncoding', () => {
  const spectrum = {
    x: xAxis,
    y: yZeros,
  };
...
test('create and read spectrum y decimal with yEncoding and specify yFactor', () => {
  const spectrum = {
    x: xAxis,
    y: yDecimal,
  };
...
test('create and read spectrum y decimal with yEncoding, no yFactor', () => {
  const spectrum = {
    x: xAxis,
    y: yDecimal,
  };
...
test('create and read spectrum with yEncoding and x and y decimals', () => {
  const spectrum = {
    x: xDecimal,
    y: yDecimal,
  };
...
test('create and read spectrum DIFDUP xyEncoding negative values', () => {
