...
test('3 variables with isDependent', () => {
  const variables: MeasurementXYVariables = {
    x: {
      data: [1, 2, 3, 4],
      symbol: 'X',
...
test('3 variables width specific independent / dependent', () => {
  const variables: MeasurementXYVariables = {
    x: {
      data: [1, 2, 3, 4],
      symbol: 'X',
...
test('x / y variables, forceNtuples', () => {
  const variables: MeasurementXYVariables = {
    x: { data: [1, 2, 3, 4], label: 'x value', units: 'x unit' },
    y: { data: [2, 3, 4, 5], label: 'y value', units: 'y unit' },
  };
...
test('x / y variables, forceNtuples and type', () => {
  const variables: MeasurementXYVariables = {
    x: {
      data: [1, 2, 3, 4],
      label: 'x value',
